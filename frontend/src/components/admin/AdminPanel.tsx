...
const AdminPanel: React.FC = () => {
  ...
  const [activeSection, setActiveSection] = useState<'overview' | 'teachers' | 'students' | 'settings'>('overview');
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow p-8 text-center">
          ...
          <p className="mt-2 text-gray-600">Administrator privileges required to access this panel.</p>
        </div>
      </div>
    );
  }
      ...
      case 'teachers':
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <p className="text-gray-600">Teacher management interface will be implemented here.</p>
            </div>
          </div>
        );
      ...
      <div className="w-64 bg-white shadow-lg">
        ...
        <nav className="mt-6">
          {sidebarItems.map((item) => (
            <button
              key={item.id}
              onClick={() => setActiveSection(item.id as 'overview' | 'teachers' | 'students' | 'settings')}
          ...
          <div className=" border-t">
            <button
              ...
              className="w-full flex items-center px-6 py-3 text-left hover:bg-gray-100 transition-colors text-red-600 hover:text-red-500"
            >
              <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {showTeacherRegistration && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="max-w-md w-full">
            <TeacherRegistration onClose={() => setShowTeacherRegistration(false)} />
          </div>
        </div>
      )}
    </div>
